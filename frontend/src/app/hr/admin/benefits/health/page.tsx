      ...
      <div className="w-full max-w-6xl mx-auto space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-[#6B7280] dark:text-[#9CA3AF] mt-1">Create, update, and manage health benefit plans</p>
          </div>
          <div className="flex gap-2">
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[700px] max-h-[600px] overflow-y-auto">
                <DialogHeader>
                  <DialogTitle>
                    {selectedBenefit ? "Edit Health Benefit Plan" : "Create Health Benefit Plan"}
                  </DialogTitle>
                  <DialogDescription>
                    {selectedBenefit
                      ? "Update the details of the health benefit plan."
                      : "Fill in the details to create a new health benefit plan."}
                  </DialogDescription>
                </DialogHeader>
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
              <div>
                ...
                <CardDescription className="text-[#6B7280] dark:text-[#9CA3AF] mt-1">
                  View and manage health benefit plans
                </CardDescription>
              </div>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12 border border-dashed border-[#E5E7EB] dark:border-[#374151] rounded-lg bg-[#F9FAFB] dark:bg-[#111827]/50">
                ...
                <p className="text-[#6B7280] dark:text-[#9CA3AF] max-w-md mx-auto mb-6">
                  There are no health benefit plans in the system yet. Create your first plan to get started.
                </p>
                <Button
