...
export default function RetirementBenefitsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error("Failed to save retirement plan");
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (!response.ok) throw new Error("Failed to deactivate retirement plan");
      
      toast.success("Retirement plan deactivated successfully");
      setIsDeleteDialogOpen(false);
      fetchBenefits();
    } catch (error) {
      toast.error("Failed to deactivate retirement plan");
    }
  };
      ...
      <div className="w-full max-w-6xl mx-auto space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-[#6B7280] dark:text-[#9CA3AF] mt-1">Create, update, and manage retirement benefit plans</p>
          </div>
          <div className="flex gap-2">
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[700px] max-h-[600px] overflow-y-auto">
                <DialogHeader>
                  <DialogTitle>
                    {selectedBenefit ? "Edit Retirement Plan" : "Create Retirement Plan"}
                  </DialogTitle>
                  <DialogDescription>
                    {selectedBenefit
                      ? "Update the details of the retirement benefit plan."
                      : "Fill in the details to create a new retirement benefit plan."}
                  </DialogDescription>
                </DialogHeader>
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
              <div>
                ...
                <CardDescription className="text-[#6B7280] dark:text-[#9CA3AF] mt-1">
                  View and manage retirement benefit plans
                </CardDescription>
              </div>
          ...
          <CardContent className="p-6">
            {isLoading ? (
              ...
              <div className="text-center py-12 border border-dashed border-[#E5E7EB] dark:border-[#374151] rounded-lg bg-[#F9FAFB] dark:bg-[#111827]/50">
                ...
                <h3 className="text-xl font-medium text-[#1F2937] dark:text-white mb-2">No retirement plans found</h3>
                <p className="text-[#6B7280] dark:text-[#9CA3AF] max-w-md mx-auto mb-6">
                  There are no retirement benefit plans in the system yet. Create your first plan to get started.
                </p>
                <Button
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              You can only deactivate the retirement plan if it is not currently being used by any employees. 
              This will deactivate the retirement plan. Employees will no longer be
