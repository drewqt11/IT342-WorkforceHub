      ...
      <SidebarContent className="px-5 py-6">
        <SidebarMenu className="space-y-2">
          ...
          <SidebarMenuItem>
            ...
            >
              <Link href="/employee/dashboard" className="py-2.5">
                <div className="flex items-center gap-4 w-full">
                  <div
                    className={`h-9 w-9 rounded-lg flex items-center justify-center transition-all duration-300 ${isActive("/employee/dashboard")
                  ...
                  <span
                    className={`font-medium transition-colors duration-300 ${isActive("/employee/dashboard")
