                ...
                <div className="rounded-lg border border-[#E5E7EB] bg-white p-5 shadow-sm">
                  ...
                  <div className="relative mt-2">
                    ...
                    <Button
                      ...
                      className="relative w-full border-0 bg-[#0078D4] hover:bg-[#106EBE] py-4 sm:py-6 font-medium text-white"
                      disabled={isLoading}
                    >
                      <div className="flex w-full items-center justify-between px-2 sm:px-4">
                        <div className="flex items-center">
                          <div className="mr-2 sm:mr-3 flex h-6 w-6 sm:h-8 sm:w-8 items-center justify-center bg-white rounded-sm">
                            <svg
                        ...
                        <ArrowRight className="h-6 w-6 sm:h-5 sm:w-5 mr-6 text-white" />
                      </div>
                    </Button>
                  </div>
                </div>
