...
fun SideBarMenu(
    ...
    Column(
        modifier = Modifier
            .fillMaxHeight()
            .width(300.dp)
            .background(cit.edu.workforcehub.presentation.theme.AppColors.white)
    ) {
...
fun MenuNavItem(
    ...
    tint: Color = cit.edu.workforcehub.presentation.theme.AppColors.gray700,
    backgroundColor: Color? = null,
    onClick: () -> Unit
) {
    val background = when {
        backgroundColor != null -> backgroundColor
        isSelected -> cit.edu.workforcehub.presentation.theme.AppColors.blue50
        else -> Color.Transparent
    }
    val textColor = if (isSelected) cit.edu.workforcehub.presentation.theme.AppColors.blue700 else tint
    val iconTint = if (isSelected) cit.edu.workforcehub.presentation.theme.AppColors.blue700 else tint
